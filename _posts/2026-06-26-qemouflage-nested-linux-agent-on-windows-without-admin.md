...
image:
  path: /assets/img/qemouflage/cover.png
  alt: "Qemouflage, hiding a Linux agent inside a Windows host"
---
...
Before getting into the how, it's worth understanding *why* running inside a VM is such a problem for endpoint security.
...
3. **Compile**: the TCG backend compiles those ops into native host machine code (x86_64 in our case)
...
![0/67 detections on VirusTotal](/assets/img/qemouflage/vt.png)
...
*This tool is intended for authorized Red Team engagements and security research.*
